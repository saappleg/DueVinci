-- DueVinci Dev: Canvas LMS and subscription foundation.
-- This migration keeps the existing free planner schema intact. Canvas Sync is
-- subscription-gated in the UI; it does not gate manually created coursework.
