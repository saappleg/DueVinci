...
export async function renderTodayWorkspace() {
    ...
    if (!card) { card = document.createElement('section'); card.id = 'todayWorkspace'; dashboard.insertBefore(card, dashboard.querySelector(':scope > .grid') || null); }
    ...
    card.className = 'mb-6 overflow-hidden rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50 via-white to-violet-50 p-6 dark:border-indigo-500/20 dark:from-brand-800 dark:via-brand-800 dark:to-indigo-950/30';
