...
import { startWalkthrough, updateTourButtonVisibility, replayTourFromSettings, showFirstRunOnboarding, openWhatsNewModal, closeWhatsNewModal, checkWhatsNewOnLaunch, checkImporterBetaOnLaunch, hydrateImporterPoll } from './modules/tour.js?v=2.4.0';
...
import { triggerPWAInstall, dismissPWABanner, initPWA } from './modules/pwa.js?v=2.4.0';
