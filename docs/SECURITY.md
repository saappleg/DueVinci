...
- **Google Gemini API** – Used for syllabus parsing. DueVinci does not train models on student inputs; Google’s handling of prompts and outputs depends on the applicable Gemini service tier and terms. Do not represent AI inputs as exempt from provider processing.
...
- **Account Deletion** – You may remove your account and profile photo through the app. Provider-held data may remain subject to the provider’s policy or legal obligations.
